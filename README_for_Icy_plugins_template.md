...
{short_description}        
A more detailed user documentation can be found on the {plugin_title} documentation page on the Icy website: {documentation_url}               
