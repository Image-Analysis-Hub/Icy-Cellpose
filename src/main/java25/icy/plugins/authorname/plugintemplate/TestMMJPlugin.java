 ...
 * <p>
 * This shows you that you can define the same class with different versions of Java (this one is compiled in Java 25).
 */
@IcyPluginName("MMJ 25")
public class TestMMJPlugin extends PluginActionable {
    ...
    @Override
    public void run() {
        IcyLogger.success(this.getClass(), "MMJ: 25");
    }
}
